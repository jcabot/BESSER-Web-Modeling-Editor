...
import { AgentStateTransitionInit } from './agent-state-transition-init';
import { ThemedPath, ThemedPolyline } from '../../../components/theme/themedComponents';

export const AgentStateTransitionInitComponent: FunctionComponent<Props> = ({ element }) => {
...
interface Props {
  element: AgentStateTransitionInit;
}